/*
	DB Type : MYSQL5.7
	Author : libingbin2016@aliyun.com

	Tips；Mysql中如果表和表之间建立的外键约束，则无法删除表及修改表结构。
...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='内容分类表';
...
CREATE TABLE `tb_order_shipping` (
  ...
  `updated` datetime DEFAULT NULL,
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单收货人信息表';
