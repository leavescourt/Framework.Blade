...
import com.bingbinlee.blade.mapper.TbUserMapper;
import com.bingbinlee.blade.pojo.TbUser;
import com.bingbinlee.blade.pojo.TbUserExample;
...
public class UserServiceImpl implements UserService {
	...
	public BladeResult getUserByToken(String token) {
		...
		jedisClient.expire(REDIS_USER_SESSION_KEY + ":" + token, SSO_SESSION_EXPIRE);
		//返回用户信息
		return BladeResult.ok(JsonUtils.jsonToPojo(json, TbUser.class));
	}
